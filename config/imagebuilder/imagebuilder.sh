...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        xz-utils ziptool zoneinfo-asia zoneinfo-core zstd kmod-usb-net-rtl8150 kmod-usb-net-rtl8152 \
        \
        ...
        luci-proto-3g luci-proto-bonding luci-proto-ipip luci-proto-ncm  \
